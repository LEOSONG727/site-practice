    ...
    <main className="min-h-screen py-10">
      <div className="max-w-2xl mx-auto px-4">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <h1 className="text-2xl font-bold text-[#191F28]">새 글 작성</h1>
        </div>
        ...
        >
          ...
          <div>
            ...
            <textarea
              ...
              required
              rows={10}
              className="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm text-[#191F28] placeholder-[#8B95A1] focus:outline-none focus:ring-2 focus:ring-[#3182F6] focus:border-transparent transition resize-none"
            />
          </div>
